...
export function getMessageContent(
	...
	// Always disable workflow attribution links for Slack messages in this fork.
	// This ensures existing workflows with persisted "includeLinkToWorkflow: true"
	// also stop appending the "Automated with this n8n workflow" footer.
	const includeLinkToWorkflow = false;
