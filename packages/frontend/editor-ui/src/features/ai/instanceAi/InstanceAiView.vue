...
// mnetplus: show chat history sidebar by default
const sidebarCollapsed = useSessionStorage('instanceAi.sidebarCollapsed', false);
...
// mnetplus: keep chat history sidebar open while navigating within Workflow AI.
...
onBeforeRouteLeave((to) => {
	...
	if (!name || !CHAT_ROUTE_NAMES.has(name)) {
		// Only collapse when leaving Workflow AI entirely (e.g. workflows canvas).
