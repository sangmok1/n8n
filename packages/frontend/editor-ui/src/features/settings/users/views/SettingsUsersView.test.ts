...
describe('SettingsUsersView', () => {
	...
	it('should not show advanced permissions notice when feature is disabled', () => {
		settingsStore.settings.enterprise[EnterpriseEditionFeature.AdvancedPermissions] = false;

		renderComponent();

		expect(screen.queryByTestId('upgrade-permissions-link')).not.toBeInTheDocument();
	});
	...
	describe('upgrade functionality', () => {
		...
		it('should not render advanced permissions upgrade link', () => {
