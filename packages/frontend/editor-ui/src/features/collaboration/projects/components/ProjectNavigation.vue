...
// mnetplus: Workflow AI is always visible in the sidebar
const isInstanceAiNavVisible = computed(() => true);
...
const home = computed<IMenuItem>(() => ({
	id: 'home',
	label: locale.locale === 'ko' ? '홈' : locale.baseText('projects.menu.overview'),
	icon: 'house',
	route: {
