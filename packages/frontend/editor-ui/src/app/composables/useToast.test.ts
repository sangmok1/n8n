...
describe('useToast', () => {
	...
	describe('error and warning toast behavior', () => {
		it('should not show duplicate error notifications while one is active', async () => {
			const messageData = {
		...
		it('should not show duplicate warning notifications while one is active', async () => {
			const messageData = {
