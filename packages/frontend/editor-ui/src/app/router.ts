...
const SignupRequestView = async () => await import('@/features/core/auth/views/SignupRequestView.vue');
...
export const routes: RouteRecordRaw[] = [
	{
		...
		beforeEnter: (_to, _from, next) => {
			if (canMessageInstanceAi()) {
				next({ name: INSTANCE_AI_VIEW });
				return;
			}
			next('/home/workflows');
		},
