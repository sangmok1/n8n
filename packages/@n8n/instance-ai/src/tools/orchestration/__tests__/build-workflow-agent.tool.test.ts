...
describe('buildWarmBuilderFollowUp', () => {
	it('keeps the detached builder submit-first contract in warm follow-ups', () => {
...
describe('determineVerificationReadiness', () => {
	it('treats submitted workflows as already verified', () => {
		expect(
			determineVerificationReadiness({
				submitted: true,
				workflowId: 'workflow-1',
	...
	it('ignores pin-data details and still returns already_verified', () => {
		expect(
			determineVerificationReadiness({
				submitted: true,
				workflowId: 'workflow-1',
	...
	it('does not route placeholders to setup', () => {
		expect(
			determineVerificationReadiness({
				submitted: true,
				workflowId: 'workflow-1',
	...
	it('does not block on trigger type after submit', () => {
		expect(
			determineVerificationReadiness({
				submitted: true,
				workflowId: 'workflow-1',
...
describe('determineSetupRequirement', () => {
	it('does not require setup for mocked credentials', () => {
		expect(
			determineSetupRequirement({
				submitted: true,
				workflowId: 'workflow-1',
	...
	it('does not require setup for unresolved placeholders', () => {
		expect(
			determineSetupRequirement({
				submitted: true,
				workflowId: 'workflow-1',
